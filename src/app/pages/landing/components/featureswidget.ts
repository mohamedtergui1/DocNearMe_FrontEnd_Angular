...
@Component({
    ...
    <div class="grid grid-cols-12 gap-4 justify-center">
        <div class="col-span-12 text-center mt-20 mb-6">
            <div class="text-surface-900 dark:text-surface-0 font-normal mb-2 text-4xl">Comprehensive Healthcare Services</div>
            <span class="text-muted-color text-2xl">Your health, our priority</span>
        </div>
            ...
            <div style="height: 160px; padding: 2px; border-radius: 10px; background: linear-gradient(90deg, rgba(253, 228, 165, 0.2), rgba(187, 199, 205, 0.2)), linear-gradient(180deg, rgba(253, 228, 165, 0.2), rgba(187, 199, 205, 0.2))">
                <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                    <div class="flex items-center justify-center bg-yellow-200 mb-4" style="width: 3.5rem; height: 3.5rem; border-radius: 10px">
                        <i class="pi pi-fw pi-user-plus !text-2xl text-yellow-700"></i>
                    </div>
                    <h5 class="mb-2 text-surface-900 dark:text-surface-0">Easy Appointments</h5>
                    <span class="text-surface-600 dark:text-surface-200">Book your consultation with just a few clicks.</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
            <div style="height: 160px; padding: 2px; border-radius: 10px; background: linear-gradient(90deg, rgba(145, 226, 237, 0.2), rgba(251, 199, 145, 0.2)), linear-gradient(180deg, rgba(253, 228, 165, 0.2), rgba(172, 180, 223, 0.2))">
                <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                    ...
                    <h5 class="mb-2 text-surface-900 dark:text-surface-0">Expert Care</h5>
                    <span class="text-surface-600 dark:text-surface-200">Experienced doctors at your service.</span>
                </div>
            </div>
        </div>
            ...
            <div style="height: 160px; padding: 2px; border-radius: 10px; background: linear-gradient(90deg, rgba(145, 226, 237, 0.2), rgba(172, 180, 223, 0.2)), linear-gradient(180deg, rgba(172, 180, 223, 0.2), rgba(246, 158, 188, 0.2))">
                <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                    <div class="flex items-center justify-center bg-indigo-200" style="width: 3.5rem; height: 3.5rem; border-radius: 10px">
                        <i class="pi pi-fw pi-clock !text-2xl text-indigo-700"></i>
                    </div>
                    <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">24/7 Support</div>
                    <span class="text-surface-600 dark:text-surface-200">Round-the-clock medical assistance.</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
            <div style="height: 160px; padding: 2px; border-radius: 10px; background: linear-gradient(90deg, rgba(187, 199, 205, 0.2), rgba(251, 199, 145, 0.2)), linear-gradient(180deg, rgba(253, 228, 165, 0.2), rgba(145, 210, 204, 0.2))">
                <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                    ...
                    <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">Telemedicine</div>
                    <span class="text-surface-600 dark:text-surface-200">Virtual consultations for your convenience.</span>
                </div>
            </div>
        </div>
            ...
            <div style="height: 160px; padding: 2px; border-radius: 10px; background: linear-gradient(90deg, rgba(187, 199, 205, 0.2), rgba(246, 158, 188, 0.2)), linear-gradient(180deg, rgba(145, 226, 237, 0.2), rgba(160, 210, 250, 0.2))">
                <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                    <div class="flex items-center justify-center bg-orange-200 mb-4" style="width: 3.5rem; height: 3.5rem; border-radius: 10px">
                        <i class="pi pi-fw pi-file-pdf !text-2xl text-orange-700"></i>
                    </div>
                    <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">Digital Records</div>
                    <span class="text-surface-600 dark:text-surface-200">Secure access to your medical history.</span>
                </div>
            </div>
        </div>
            ...
            <div style="height: 160px; padding: 2px; border-radius: 10px; background: linear-gradient(90deg, rgba(251, 199, 145, 0.2), rgba(246, 158, 188, 0.2)), linear-gradient(180deg, rgba(172, 180, 223, 0.2), rgba(212, 162, 221, 0.2))">
                <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                    <div class="flex items-center justify-center bg-pink-200 mb-4" style="width: 3.5rem; height: 3.5rem; border-radius: 10px">
                        <i class="pi pi-fw pi-calendar !text-2xl text-pink-700"></i>
                    </div>
                    <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">Flexible Scheduling</div>
                    <span class="text-surface-600 dark:text-surface-200">Choose appointment times that suit you.</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 mt-6 lg:mt-0">
            <div style="height: 160px; padding: 2px; border-radius: 10px; background: linear-gradient(90deg, rgba(145, 210, 204, 0.2), rgba(160, 210, 250, 0.2)), linear-gradient(180deg, rgba(187, 199, 205, 0.2), rgba(145, 210, 204, 0.2))">
                <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                    ...
                    <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">Health Insurance</div>
                    <span class="text-surface-600 dark:text-surface-200">We work with major insurance providers.</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 mt-6 lg:mt-0">
            <div style="height: 160px; padding: 2px; border-radius: 10px; background: linear-gradient(90deg, rgba(145, 210, 204, 0.2), rgba(212, 162, 221, 0.2)), linear-gradient(180deg, rgba(251, 199, 145, 0.2), rgba(160, 210, 250, 0.2))">
                <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                    ...
                    <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">Health Education</div>
                    <span class="text-surface-600 dark:text-surface-200">Access to health tips and resources.</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg-4 mt-6 lg:mt-0">
            <div style="height: 160px; padding: 2px; border-radius: 10px; background: linear-gradient(90deg, rgba(160, 210, 250, 0.2), rgba(212, 162, 221, 0.2)), linear-gradient(180deg, rgba(246, 158, 188, 0.2), rgba(212, 162, 221, 0.2))">
                <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                    ...
                    <span class="text-surface-600 dark:text-surface-200">Your medical information is secure with us.</span>
                </div>
            </div>
        </div>
        ...
        >
            <div class="flex flex-col justify-center items-center text-center px-4 py-4 md:py-0">
                <div class="text-gray-900 mb-2 text-3xl font-semibold">Dr. Sophie Martin</div>
                <span class="text-gray-600 text-2xl">Chief Medical Officer</span>
                <p class="text-gray-900 sm:line-height-2 md:line-height-4 text-2xl mt-6" style="max-width: 800px">
                    "At our healthcare facility, we are committed to providing top-notch medical care with a patient-centric approach. Our team of experienced professionals ensures that every patient receives personalized attention and the best possible treatment."
                </p>
                <img src="https://primefaces.org/cdn/templates/sakai/landing/peak-logo.svg" class="mt-6" alt="Hospital logo" />
            </div>
        </div>
    </div>
</div>`
